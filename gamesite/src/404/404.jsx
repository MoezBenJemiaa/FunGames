...
useEffect(() => {
  ...
  const yetiTL = new TimelineMax({ paused: true, repeat: -1, delay: 0 });
  yetiTL
    ...
    .add(() => {
      chatterTL.pause();
      gsap.to(['#mouthBG', '#mouthPath', '#mouthOutline'], 0.1, { morphSVG: mouthShape1 });
    }, "3.2")
    .to(['#mouthBG', '#mouthPath', '#mouthOutline'], 0.25, { morphSVG: mouthShape2 }, "5")
    .to('#tooth1', 0.1, { y: -5 }, "5")
    .to('#armR', 0.5, { x: 10, y: 30, rotation: 10, transformOrigin: "bottom center", ease: "quad.out" }, "4")
    ...
    .to('#tooth1', 0.1, { y: 0 }, "9")
    .to('#armR', 0.5, { x: 0, y: 0, rotation: 0, transformOrigin: "bottom center", ease: "quad.out" }, "9")
...
const LightSvg = (props) => (
  ...
  >
    <filter id="white-glow">
      <feFlood result="flood" floodColor="#ffffff" floodOpacity={0.6} />
    ...
    <g id="four04">
      <g opacity={0.2} id="lettersShadow">
...
const YetiSVG = (props) => (
  ...
  >
    ...
    >
      ...
      <stop offset={0.076} stopColor="#414141" />
      <stop offset={0.2213} stopColor="#555" />
      <stop offset={0.3651} stopColor="#626262" />
      <stop offset={0.5043} stopColor="#666" />
      <stop offset={0.6323} stopColor="#606060" />
      <stop offset={0.8063} stopColor="#4e4e4e" />
